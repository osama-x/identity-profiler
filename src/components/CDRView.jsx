...
const CDR_DATA = [
    ...
    { id: 16, caller: "+923335965488", receiver: "+923001234567", time: "2025-11-28 17:45:30", duration: "02m 45s", tower: "Bahawalpur - Model Town", suspicious: false },
    ...
    { id: 19, caller: "+923001234567", receiver: "+923335578758", time: "2025-11-28 19:40:25", duration: "16m 35s", tower: "Sukkur - Military Rd", suspicious: false },
            ...
            <table className="w-full text-left text-sm">
                <thead className="bg-gray-900 text-gray-400 uppercase text-xs">
                    <tr>
                        ...
                        <th className="px-4 py-3">Terminating</th>
                    ...
                    {CDR_DATA.map((record) => (
                        <tr key={record.id} className={`hover:bg-gray-700/50 transition ${record.suspicious ? 'bg-red-900/20' : ''}`}>
                            ...
                            <td className="px-4 py-3">
                                {record.suspicious ? (
                                    <span className="bg-red-900 text-red-300 px-2 py-0.5 rounded text-xs font-bold animate-pulse"> Found in Blacklist </span>
                                ) : (
